(function (n, f) {
    var r = "string", j = function (e, f) {
        return typeof e === f
    }, e = function (e) {
        return j(e, "undefined")
    }, h = function (e) {
        return j(e, "function")
    }, x = function (e) {
        ...
        var s = {MooTools: "$$", Prototype: "$$", jQuery: "*"}, p = 0, q = {}, w = l || "simpleCart", y = {};
        l = {};
        l = {};
        var u = n.localStorage, k = n.console || {msgs: [], log: function (a) {
            k.msgs.push(a)
        }}, C = {USD: {code: "USD", symbol: "&#36;", name: "US Dollar"}, AUD: {code: "AUD", symbol: "&#36;", name: "Australian Dollar"}, BRL: {code: "BRL", symbol: "R&#36;", name: "Brazilian Real"}, CAD: {code: "CAD", symbol: "&#36;", name: "Canadian Dollar"}, CZK: {code: "CZK", symbol: "&nbsp;&#75;&#269;", name: "Czech Koruna", after: !0}, DKK: {code: "DKK", symbol: "DKK&nbsp;", name: "Danish Krone"},
            EUR: {code: "EUR", symbol: "&euro;", name: "Euro"}, HKD: {code: "HKD", symbol: "&#36;", name: "Hong Kong Dollar"}, HUF: {code: "HUF", symbol: "&#70;&#116;", name: "Hungarian Forint"}, ILS: {code: "ILS", symbol: "&#8362;", name: "Israeli New Sheqel"}, JPY: {code: "JPY", symbol: "&yen;", name: "Japanese Yen"}, MXN: {code: "MXN", symbol: "&#36;", name: "Mexican Peso"}, NOK: {code: "NOK", symbol: "NOK&nbsp;", name: "Norwegian Krone"}, NZD: {code: "NZD", symbol: "&#36;", name: "New Zealand Dollar"}, PLN: {code: "PLN", symbol: "PLN&nbsp;", name: "Polish Zloty"}, GBP: {code: "GBP",
                symbol: "&pound;", name: "Pound Sterling"}, SGD: {code: "SGD", symbol: "&#36;", name: "Singapore Dollar"}, SEK: {code: "SEK", symbol: "SEK&nbsp;", name: "Swedish Krona"}, CHF: {code: "CHF", symbol: "CHF&nbsp;", name: "Swiss Franc"}, THB: {code: "THB", symbol: "&#3647;", name: "Thai Baht"}, BTC: {code: "BTC", symbol: " BTC", name: "Bitcoin", accuracy: 4, after: !0}, "UAH": {code: "UAH", symbol: " UAH", name: "Украинская гривка"}}, m = {checkout: {type: "PayPal", email: "you@yours.com"}, currency: "USD", language: "english-us", cartStyle: "div", cartColumns: [
        ...
        ], excludeFromCheckout: ["thumb"], shippingFlatRate: 0, shippingQuantityRate: 0, shippingTotalRate: 0, shippingCustom: null, taxRate: 0, taxShipping: !1, data: {}}, b = function (a) {
            if (h(a))return b.ready(a);
            if (j(a, "object"))return b.extend(m, a)
        }, z, A;
        ...
        b.extend({isReady: !1, add: function (a, d) {
            var c = new b.Item(a || {}), g = !0, t = !0 === d ? d : !1;
            if (!t && (g = b.trigger("beforeAdd", [c]), !1 === g))return!1;
            (g = b.has(c)) ? (g.increment(c.quantity()), c = g) : q[c.id()] = c;
            b.update();
            t || b.trigger("afterAdd", [c, e(g)]);
            return c
        }, each: function (a, d) {
            var c, g = 0, t, e, v;
            if (h(a))e = a, v = q; else if (h(d))e = d, v = a; else return;
            for (c in v)if (Object.prototype.hasOwnProperty.call(v, c)) {
                t = e.call(b, v[c], g, c);
                if (!1 === t)break;
                g += 1
            }
            ...
            var d = [];
            if (j(q[a], "object"))return q[a];
            if (j(a, "object"))return b.each(function (c) {
                var g = !0;
                b.each(a, function (a, b, d) {
                    j(a, r) ? a.match(/<=.*/) ? (a = parseFloat(a.replace("<=", "")), c.get(d) && parseFloat(c.get(d)) <= a || (g = !1)) : a.match(/</) ? (a = parseFloat(a.replace("<", "")), c.get(d) && parseFloat(c.get(d)) < a || (g = !1)) : a.match(/>=/) ? (a = parseFloat(a.replace(">=", "")), c.get(d) && parseFloat(c.get(d)) >= a || (g = !1)) : a.match(/>/) ? (a = parseFloat(a.replace(">", "")), c.get(d) && parseFloat(c.get(d)) > a ||
            ...
            var a, d = n, c;
            for (c in s)if (Object.prototype.hasOwnProperty.call(s, c) && n[c] && (a = s[c].replace("*", c).split("."), (a = a.shift()) && (d = d[a]), "function" === typeof d)) {
                z = d;
                b.extend(b.ELEMENT._, y[c]);
                break
            }
        }, ids: function () {
            var a = [];
            ...
            u.setItem(w + "_items", JSON.stringify(a));
            b.trigger("afterSave")
        }, load: function () {
            q = {};
            var a = u.getItem(w + "_items");
            if (a) {
                try {
            ...
            var d = "";
            j(a, r) ? d = a : j(a, "object") && j(a.message, r) && (d = a.message);
            try {
                k.log("simpleCart(js) Error: " + d)
            } catch (c) {
            }
            b.trigger("error", a)
        }});
        ...
        A = {attr: function (a, b) {
            ...
            return"<a href='javascript:;' class='" + w + "_decrement'>" + (b.text || "-") + "</a>"
        }, increment: function (a, b) {
            return"<a href='javascript:;' class='" + w + "_increment'>" + (b.text || "+") + "</a>"
        }, image: function (a, b) {
            return"<img src='" +
                a.get(b.attr) + "'/>"
        }, input: function (a, b) {
            return"<input type='text' value='" + a.get(b.attr) + "' class='" + w + "_input'/>"
        }, remove: function (a, b) {
            return"<a href='javascript:;' class='" + w + "_remove'>" + (b.text || "X") + "</a>"
        }};
        b.extend({writeCart: function (a) {
            var d = m.cartStyle.toLowerCase(), c = "table" === d, g = c ? "tr" : "div", t = c ? "th" : "div", e = c ? "td" : "div", v = b.$create(d), d = b.$create(g).addClass("headerRow"), f, h;
            b.$(a).html(" ").append(v);
            v.append(d);
            c = 0;
            for (h = m.cartColumns.length; c < h; c += 1)f = D(m.cartColumns[c]), a = "item-" +
                (f.attr || f.view || f.label || f.text || "cell") + " " + f.className, f = f.label || "", d.append(b.$create(t).addClass(a).html(f));
            b.each(function (a, d) {
                b.createCartRow(a, d, g, e, v)
            });
            return v
        }, createCartRow: function (a, d, c, g, t) {
            d = b.$create(c).addClass("itemRow row-" + d + " " + (d % 2 ? "even" : "odd")).attr("id", "cartItem_" + a.id());
            var e, f, k;
            t.append(d);
            t = 0;
            for (c = m.cartColumns.length; t < c; t += 1)e = D(m.cartColumns[t]), f = "item-" + (e.attr || (j(e.view, r) ? e.view : e.label || e.text || "cell")) + " " + e.className, k = a, k = (h(e.view) ? e.view : j(e.view,
                r) && h(A[e.view]) ? A[e.view] : A.attr).call(b, k, e), f = b.$create(g).addClass(f).html(k), d.append(f);
            return d
        }});
        b.Item = function (a) {
            function d() {
                j(c.price, r) && (c.price = parseFloat(c.price.replace(b.currency().decimal, ".").replace(/[^0-9\.]+/ig, "")));
                isNaN(c.price) && (c.price = 0);
                0 > c.price && (c.price = 0);
                j(c.quantity, r) && (c.quantity = parseInt(c.quantity.replace(b.currency().delimiter, ""), 10));
                isNaN(c.quantity) && (c.quantity = 1);
                0 >= c.quantity && g.remove()
            }

            var c = {}, g = this;
            j(a, "object") && b.extend(c, a);
            p += 1;
            for (c.id =
                     c.id || "SCI-" + p; !e(q[c.id]);)p += 1, c.id = "SCI-" + p;
            g.get = function (a, b) {
                var d = !b;
        ...
        b.Item._ = b.Item.prototype = {increment: function (a) {
            ...
            if (!1 === b.trigger("beforeRemove", [q[this.id()]]))return!1;
            delete q[this.id()];
            a || b.update();
            return null
        ...
        b.extend(l);
        b.extend(b.Item._, l);
        l = {beforeAdd: null, afterAdd: null, load: null, beforeSave: null, afterSave: null, update: null, ready: null, checkoutSuccess: null, checkoutFail: null, beforeCheckout: null, beforeRemove: null};
        b(l);
        b.each(l, function (a, d, c) {
            b.bind(c, function () {
        ...
        b.extend({currency: function (a) {
            if (j(a, r) && !e(C[a]))m.currency = a; else if (j(a, "object"))C[a.code] = a, m.currency = a.code; else return C[m.currency]
        }});
        b.extend({bindOutlets: function (a) {
            ...
            var c = d.call(b, a);
            j(c, "object") && c.el ? b.$(a).html(" ").append(c) : e(c) || b.$(a).html(c)
        }, bindInputs: function (a) {
            b.each(a, function (a) {
                b.setInput("." +
                    w + "_" + a.selector, a.event, a.callback)
            })
        ...
        b.extend(y, {MooTools: {text: function (a) {
            ...
            if (h(b)) {
                ...
                f.observe(a, function (a, e) {
                    e === z(a).findElement(c) && b.call(e, a)
                })
            }
        }, parent: function () {
            return b.$(this.el.up())
            ...
            submit: function () {
                ...
                j(a, r) ? this.el = z(a) : x(a) && (this.el = [a])
            ...
            z(f).delegate(this.selector, a, b);
            return this
        }, parent: function () {
        ...
        b.ready(function () {
            ...
            b.bindInputs([
                ...
                {selector: "shelfItem .item_add", event: "click", callback: function () {
                    var a = {};
                    b.$(this).closest("." + w + "_shelfItem").descendants().each(function (d, c) {
                        var e = b.$(c);
        ...
        f.addEventListener ? n.DOMContentLoaded = function () {
            f.removeEventListener("DOMContentLoaded", DOMContentLoaded, !1);
            b.init()
        } : f.attachEvent && (n.DOMContentLoaded = function () {
            "complete" === f.readyState && (f.detachEvent("onreadystatechange", DOMContentLoaded), b.init())
        });
        if ("complete" === f.readyState)setTimeout(b.init, 1); else if (f.addEventListener)f.addEventListener("DOMContentLoaded", DOMContentLoaded, !1), n.addEventListener("load", b.init, !1); else if (f.attachEvent) {
            f.attachEvent("onreadystatechange", DOMContentLoaded);
            n.attachEvent("onload", b.init);
            l = !1;
            try {
                l = null === n.frameElement
            } catch (F) {
            }
            f.documentElement.doScroll && l && E()
        }
        return b
    };
    n.simpleCart = B()
...
(function () {
    ...
    function r(e, j) {
        var s, p, q, n, y = h, u, k = j[e];
        k && "object" === typeof k && "function" === typeof k.toJSON && (k = k.toJSON(e));
        "function" === typeof l && (k = l.call(j, e, k));
        switch (typeof k) {
            case "string":
                return f(k);
            case "number":
            ...
            case "object":
                ...
                if ("[object Array]" === Object.prototype.toString.apply(k)) {
                    n = k.length;
                    for (s = 0; s < n; s += 1)u[s] = r(s, k) || "null";
                    q = 0 === u.length ? "[]" : h ? "[\n" + h + u.join(",\n" + h) + "\n" + y + "]" : "[" + u.join(",") + "]";
                    h = y;
                    return q
                }
                if (l && "object" === typeof l) {
                    n = l.length;
                    for (s = 0; s < n; s += 1)"string" === typeof l[s] && (p = l[s], (q = r(p, k)) && u.push(f(p) + (h ? ": " : ":") + q))
                } else for (p in k)Object.prototype.hasOwnProperty.call(k, p) && (q = r(p, k)) && u.push(f(p) + (h ? ": " : ":") + q);
                q = 0 === u.length ? "{}" : h ? "{\n" + h + u.join(",\n" +
                    h) + "\n" + y + "}" : "{" + u.join(",") + "}";
                h = y;
                return q
    ...
    "function" !== typeof JSON.stringify && (JSON.stringify = function (e, f, j) {
        var p;
        x = h = "";
        if ("number" === typeof j)for (p = 0; p < j; p += 1)x += " "; else"string" === typeof j && (x = j);
        if ((l = f) && "function" !== typeof f && ("object" !== typeof f || "number" !== typeof f.length))throw Error("JSON.stringify");
        return r("", {"": e})
    });
    "function" !== typeof JSON.parse && (JSON.parse = function (e, f) {
        function h(e, j) {
            var l, n, k = e[j];
            if (k && "object" === typeof k)for (l in k)Object.prototype.hasOwnProperty.call(k, l) && (n = h(k, l), void 0 !== n ? k[l] = n : delete k[l]);
            return f.call(e, j, k)
        }
        ...
        e = String(e);
        j.lastIndex = 0;
        j.test(e) && (e = e.replace(j, function (e) {
            return"\\u" + ("0000" + e.charCodeAt(0).toString(16)).slice(-4)
        }));
        if (/^[\],:{}\s]*$/.test(e.replace(/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g, "@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,
            "]").replace(/(?:^|:|,)(?:\s*\[)+/g, "")))return l = eval("(" + e + ")"), "function" === typeof f ? h({"": l}, "") : l;
...
(function () {
    if (!this.localStorage)if (this.globalStorage)try {
        ...
        if (f.addBehavior) {
            ...
            var r = this.localStorage = {length: 0, setItem: function (e, h) {
                f.load("localStorage");
                e = j(e);
            ...
            f.load("localStorage");
            r.length = f.XMLDocument.documentElement.attributes.length
        }
    }
})();