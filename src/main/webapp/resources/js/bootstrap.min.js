!function (e) {
    ...
    i.prototype = {constructor: i, toggle: function (r) {
        ...
        if (i.is(".disabled, :disabled"))return;
        u = n(i), f = u.hasClass("open");
        if (!f || f && t.keyCode == 27)return t.which == 27 && u.find(r).focus(), i.click();
        s = e("[role=menu] li:not(.divider):visible a", u);
        if (!s.length)return;
        l = s.index(s.filter(":focus")), t.keyCode == 38 && l > 0 && l--, t.keyCode == 40 && l < s.length - 1 && l++, ~l || (l = 0), s.eq(l).focus()
    }};
    var s = e.fn.dropdown;
    ...
    t.prototype = {constructor: t, init: function (t, n, r) {
        ...
        for (f = o.length; f--;)u = o[f], u == "click" ? this.$element.on("click." + this.type, this.options.selector, e.proxy(this.toggle, this)) : u != "manual" && (i = u == "hover" ? "mouseenter" : "focus", s = u == "hover" ? "mouseleave" : "blur", this.$element.on(i + "." + this.type, this.options.selector, e.proxy(this.enter, this)), this.$element.on(s + "." + this.type, this.options.selector, e.proxy(this.leave, this)));
    ...
    t.prototype = {cycle: function (t) {
        ...
        var r = this.$element.find(".item.active"), i = n || r[t](), s = this.interval, o = t == "next" ? "left" : "right", u = t == "next" ? "first" : "last", f = this, l;
        this.sliding = !0, s && this.pause(), i = i.length ? i : this.$element.find(".item")[u](), l = e.Event("slide", {relatedTarget: i[0], direction: o});
