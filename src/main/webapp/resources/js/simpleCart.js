        ...
        generateSimpleCart = function (space) {
            ...
            cartColumnViews = {
                ...
                remove: function (item, column) {
                    return "<a href='javascript:;' class='btn btn-small " + namespace + "_remove'><i class='icon-remove'></i> " + (column.text || "X") + "</a>";
                }
            };
            ...
            simpleCart.extend({
                ...
                writeCart: function (selector) {
                    var TABLE = settings.cartStyle.toLowerCase(),
                        ...
                        TH = isTable ? 'th' : 'div',
                        TD = isTable ? 'td' : 'div',
                        cart_container = simpleCart.$create(TABLE).addClass('table table-hover table-condensed'),
