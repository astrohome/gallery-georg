...
public class AdminController {
    ...
    public ModelAndView adminGet(HttpSession session, HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    public ModelAndView adminEditGallery(HttpSession session, HttpServletRequest request, HttpServletResponse response,
        ...
        modelAndView.addObject("gallery", fileService.getDirectoryByTitle(title));
        return modelAndView;
    }
    ...
    public
    @ResponseBody
    String adminPost(@ModelAttribute("gallery") Gallery gallery, BindingResult result) throws IOException {
